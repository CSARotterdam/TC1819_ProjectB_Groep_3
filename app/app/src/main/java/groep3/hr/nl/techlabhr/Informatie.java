 ...
 */
public class Informatie extends Fragment implements OnMapReadyCallback {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private static final String MAPVIEW_BUNDLE_KEY = "AIzaSyBGFH6xrp2WTgVRhyA4Hzf37ypGm7EuMzY";
...
//                    + " must implement OnFragmentInteractionListener");
    ...
    public void onMapReady(GoogleMap map) {
        LatLng coordinates = new LatLng(51.917262,4.484168);
        map.addMarker(new MarkerOptions().position(coordinates).title("TechLab"));
